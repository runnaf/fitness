...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_playing_video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/playing-video */ "./js/modules/playing-video.js");
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/scroll */ "./js/modules/scroll.js");
/* harmony import */ var _modules_form_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/form-data */ "./js/modules/form-data.js");
/* harmony import */ var _modules_get_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/get-tabs */ "./js/modules/get-tabs.js");
/* harmony import */ var _modules_maskForPhone__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/maskForPhone */ "./js/modules/maskForPhone.js");
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider */ "./js/modules/slider.js");
/* harmony import */ var _modules_changing_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/changing-slider */ "./js/modules/changing-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Menu
  // playingVideo
  Object(_modules_playing_video__WEBPACK_IMPORTED_MODULE_0__["playingVideo"])(); // Slider

  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_5__["getSlider"])();
  Object(_modules_changing_slider__WEBPACK_IMPORTED_MODULE_6__["changingSlider"])(); // Scroll

  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_1__["scrolling"])(); // Tabs

  Object(_modules_get_tabs__WEBPACK_IMPORTED_MODULE_3__["getTabs"])(); // Form Data

  Object(_modules_form_data__WEBPACK_IMPORTED_MODULE_2__["storingFormData"])(); // Mask for phone input

  Object(_modules_maskForPhone__WEBPACK_IMPORTED_MODULE_4__["getMaskForPhone"])(); // Utils
  // ---------------------------------
  // Modules
  // ---------------------------------
...
/***/ "./js/modules/changing-slider.js":
/*!***************************************!*\
  !*** ./js/modules/changing-slider.js ***!
  \***************************************/
/*! exports provided: changingSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changingSlider", function() { return changingSlider; });
var changingSlider = function changingSlider() {
  var fontSliders = document.querySelectorAll('[data-front-side]');
  var sliders = document.querySelectorAll('[data-slide]');
...
/***/ "./js/modules/form-data.js":
/*!*********************************!*\
  !*** ./js/modules/form-data.js ***!
  \*********************************/
/*! exports provided: storingFormData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "storingFormData", function() { return storingFormData; });
var storingFormData = function storingFormData() {
  ...
  function getDataForm(formName, fieldsName) {
    formName.addEventListener('submit', function () {
      localStorage.clear();
      fieldsName.forEach(function (field) {
...
var getTabs = function getTabs() {
  ...
  var items = document.querySelectorAll('[data-ticket-content]');
  ...
  function openingTabs(link) {
    link.addEventListener('click', function (e) {
      ...
      if (!link.classList.contains('is-active')) {
        ...
        var index = link.getAttribute('href');
...
/***/ "./js/modules/maskForPhone.js":
/*!************************************!*\
  !*** ./js/modules/maskForPhone.js ***!
  \************************************/
/*! exports provided: getMaskForPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMaskForPhone", function() { return getMaskForPhone; });
...
var getMaskForPhone = function getMaskForPhone() {
  ...
  var onPhoneInput = function onPhoneInput(e) {
    ...
    if (['1', '2', '3', '4', '5', '6', '7', '8', '9'].indexOf(inputNumbersValue[0]) > -1) {
      var firstSymbols = Number(inputNumbersValue[0]) === 7 ? '+7' : "+7 (".concat(inputNumbersValue);
...
/***/ "./js/modules/playing-video.js":
/*!*************************************!*\
  !*** ./js/modules/playing-video.js ***!
  \*************************************/
/*! exports provided: playingVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "playingVideo", function() { return playingVideo; });
var playingVideo = function playingVideo() {
  var videoBtn = document.querySelector('[data-video-btn]');
  var picture = document.querySelector('[data-gym-picture]');
...
function scrolling() {
  ...
  var trigger = document.querySelector('[data-season-ticket]');
...
function getSlider() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__slider-container', {
  ...
  var swiperTrainer = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainers__swiper', {
    loop: true,
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
    navigation: {
